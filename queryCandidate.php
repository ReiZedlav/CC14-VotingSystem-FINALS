...
if (isset($_POST['candidate_id'])) {
    ...
    $sql = "SELECT n.FirstName, n.LastName, b.Age, b.Gender, b.Birthdate, b.CivilStatus, 
                   p.Position, p.Party, p.City, c.Votes, c.Elected
            FROM Candidate c
            JOIN Nominee n ON c.NomineeID = n.NomineeID
            JOIN NomineeBioData b ON n.NomineeID = b.NomineeID
            JOIN NomineePosition p ON n.NomineeID = p.NomineeID
            WHERE c.CandidateID = ?";
